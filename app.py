...
def prediction_function(Credit_History, married, LoanAmount, Loan_Amount_Term, ApplicantIncome, Threshold):
    try:
        data = [[Credit_History, married, LoanAmount, Loan_Amount_Term, ApplicantIncome]]
